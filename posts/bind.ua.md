...
Більшість сучасних інженерів ставляться до DNS як до SaaS товару. Ви купуєте домен на Route53 або GoDaddy, вказуєте NS-записи на їхні хмари і забуваєте про це. Ви стаєте **Споживачем** DNS.
...
Я не просто налаштовував свої власні домени; я відповідав за **Реєстр**, на який покладалися інші люди. Я підтримував базу даних, яка казала: "Якщо ви шукаєте `company.lviv.ua`, йдіть поговоріть з цими неймсерверами".

З цієї точки огляду ви розумієте, що DNS — це не магія. Це сувора ієрархія делегування. І ця ієрархія покладається на протокол, старіший за сам веб: **WHOIS**.
...
**Урок:** Якщо ви змінюєте IP вашого BIND сервера, ви не можете просто оновити свій файл зони. Ви повинні оновити **Реєстратора (WHOIS)**, інакше ваш сайт згасне.
