...
У мої дні хостингу причиною падіння серверів №1 були не хакери — це були **повні диски**. Але "повний" не завжди означає те, що ви думаєте.
...
Коли `/` заповнюється, ваша оболонка не може створювати тимчасові файли, ви не можете натиснути `Tab` для автодоповнення, і SSH може навіть відхилити вас.
